...
function deleteServerData() {
    ...
    console.log("X-User header is: [" + headers['X-User']+ "]");
    ...
    var deleteRequest = Request({
      ...
      onComplete: function (response) {
          console.log("DELETE Got response status: ["+response.status+"]");
          console.log("DELETE Got response status: ["+response.statusText+"]");
          for (var headerName in response.headers) {
              console.log(headerName + ":" + response.headers[headerName]);
          }
          console.log("DELETE Got response text: ["+response.text+"]");
      }
    });
...
function uploadFile(short_filename, uploadAttempt) {
    ...
    var heatmapRequest = Request({
      ...
      onComplete: function (response) {
          ...
          console.log("UPLOAD Got response status: ["+response.statusText+"]");
          for (var headerName in response.headers) {
              console.log(headerName + ":" + response.headers[headerName]);
          }
