...
var getEncryptFlag = require("./heatmap_config").getEncryptFlag;
var getRootURL = require("./heatmap_config").getRootURL;

function getUploadURL() {
    return getRootURL() + "/upload";
}

function getDeleteURL() {
    return getRootURL() + "/delete";
}
