...
var Heatmap = function() {
    ...
    // Load the JSON
    fs.readFile("../data/pornfilter.bfilter", 'utf8', (err, data) => {
        if(err) {
        ...
        console.log("Trying to load bloom filter!");
        var bloom = new BloomFilter(array, 3);
        this.porn_filter['bloomfilter'] = bloom;
        console.log("Bloom filter is loaded!");


        console.log("ztod.com " + bloom.test("ztod.com"));
...
Heatmap.prototype = {
    ...
    clean_url: function(url) {
        ...
        if (basic_auth.test(url)) {
            console.log("basic auth URL dropped : " + url);
            return "";
        }
    ...
    flushData: function() {
        ...
        for (var url in HISTORY_RECORDS) {
            ...
            console.log("POST: Cleaning URL: " + url);
