...
Heatmap.prototype = {
    // TODO: this seems to be called from nowhere. fix it
    getUUID: function() {
        /*
    ...
    flushData: function() {
        ...
        var short_filename = "heatmap.history_"+stamp+".json";
        var profileDir = FileUtils.getFile("ProfD", []);
    ...
    readStringFromFile: function (short_filename) {
        var file = Cc["@mozilla.org/file/directory_service;1"].getService(Ci.nsIProperties).get("ProfD", Ci.nsIFile);
    ...
    writeStringToFile: function (short_filename, data) {
        ...
        fs.init(file, PR_WRONLY | PR_CREATE_FILE | PR_TRUNCATE, 1636, 0); // write only, create, truncate
        ...
        libnetwork.uploadFile(short_filename, 0);
    }
};
