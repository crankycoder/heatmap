...
var fathom_heatmap = require("./fathom-heatmap");
...
function main() {
    ...
    function startListening(worker) {
        worker.port.on('rootElement', function(docText) {
            // Just fire off the document HTML for processing by the
            // fathom-heatmap module
            Services.obs.notifyObservers(null, DOCUMENT_ONREADY, docText);
        });
    }
    ...
    pageMod.PageMod({
        ...
        contentScriptFile: dataDir.url('pagemod.js'),
        attachTo: 'top',
